    ...
    return [
        {
            ...
            "content": (
                ...
                "Emit canonical field names such as company, roles, employment_types, location, status, priority, current_stages, comments, and next_action. "
                "Extract the company into fields.company. "
                "Extract one or more roles into fields.roles. "
                "For list-valued fields such as roles, employment_types, and current_stages, always emit JSON arrays. "
                ...
                "\"Neilsoft sathi AI Engineer role, fulltime onsite, high priority\" -> patch_active_draft({\"fields\":{\"company\":\"Neilsoft\",\"roles\":[\"AI Engineer\"],\"employment_types\":[\"Full Time\"],\"location\":\"onsite\",\"priority\":\"HIGH\"},\"replace_explicit_fields\":true,\"context_notes\":[]}). "
                "\"For Neilsoft, set role to AI Engineer and status applied\" -> preview_existing_application_update({\"target\":{\"company\":\"Neilsoft\"},\"fields\":{\"roles\":[\"AI Engineer\"],\"status\":\"Applied\"},\"replace_explicit_fields\":true}). "
                ...
                "\"At Neilsoft, role is Applied AI Engineer\" -> patch_active_draft({\"fields\":{\"company\":\"Neilsoft\",\"roles\":[\"Applied AI Engineer\"]},\"replace_explicit_fields\":true,\"context_notes\":[]}). "
    ...
    return [
        {
            ...
            "content": (
                ...
                "Roles are free-form job titles. "
                "Emit arrays for roles, employment_types, and current_stages. "
                ...
                "{\"company\":\"Neilsoft\",\"roles\":[\"AI Engineer\"]}. "
                "\"Neilsoft sathi fulltime AI Engineer application onsite thev\" -> "
                "{\"company\":\"Neilsoft\",\"roles\":[\"AI Engineer\"],\"employment_types\":[\"fulltime\"],\"location\":\"onsite\"}. "
    ...
    return [
        {
            ...
            "function": {
                ...
                "description": (
                    ...
                    "Company and other fields may appear in any natural order. Extract company into fields.company and one or more roles into fields.roles. "
                    "Emit canonical field names. For list-valued fields such as roles, employment_types, and current_stages, always emit JSON arrays. "
